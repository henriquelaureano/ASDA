...
\textbf{(i.) \(n_{A} = n_{B}\) = 30.} \\

\underline{Solution:} \\

<<>>=
# <code r> ===================================================================== #
na <- nb <- 30 # sample sizes
...
hist(ts, freq = FALSE, col = "gray60", las = 1, xlab = "", ylab = ""
     , axes = FALSE, main = "something, be creative!")
lines(density(ts), col = "#0080ff", lwd = 2)
axis(side = 1, at = -4:4)
# </code r> ==================================================================== #
@

\textbf{(ii.) \(n_{A}\) = 25, \(n_{B}\) = 40.} \\
