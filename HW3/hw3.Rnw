...
\fbox{As our Test Statistic is less than the critical value, we reject the
      \(H_{0}\).} \\

\fbox{\begin{minipage}{\linewidth}
       We have statistical evidence to reject \(H_{0}\), in other words, we have
       evidence that exist difference statiscally significant between the mean of
       the child's test score at age 3 of mothers that completed the high school
       and the mean of the child's test score at age 3 of mothers that didn't
