...
<<fig.width=10, fig.height=4.25, fig.cap="Empirical distribution of \\(T_{1}\\) when the null hypothesis in correct for two different pair of sample sizes. In blue we have the estimated density for this distributions and in red the 2.5th and 97.5th percentiles.">>=
# <code r> ===================================================================== #
pia <- pib <- .67 # population proportions
