...
Schizophrenia is bigger in females than in males for the intervals < 15 and > 65,
and bigger in males in the complementar interval (age between 15 and 65 years
old).
